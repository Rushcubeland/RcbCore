...
public class MuteCommand extends Command {
    ...
    private static final String cmd = "mute";
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args[1].equalsIgnoreCase("perm")) {
            RcbAPI.getInstance().getMuteManager().mute(targetUUID, -1L, reason, sender.getName());
        ...
        RcbAPI.getInstance().getMuteManager().mute(targetUUID, muteTime, reason, sender.getName());
