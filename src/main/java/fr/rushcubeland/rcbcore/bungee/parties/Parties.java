...
public class Parties {
    ...
    private static void requestFormat(ProxiedPlayer sender, ProxiedPlayer target){
        ...
        accept.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,  new ComponentBuilder("/group accept " + sender.getDisplayName()).create()));
        ...
        deny.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,  new ComponentBuilder("/group deny " + sender.getDisplayName()).create()));
