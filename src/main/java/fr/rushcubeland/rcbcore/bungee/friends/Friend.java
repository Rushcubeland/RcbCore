            ...
            if(aOptions52.getStateFriendRequests().equals(OptionUnit.OPEN)){
                if(datarequest.containsKey(sender)){
                    if(!(datarequest.get(sender).contains(receiver))){
                        ...
                        accept.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("/f accept " + sender.getName()).create()));
                        ...
                        deny.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder("/f deny " + sender.getName()).create()));
