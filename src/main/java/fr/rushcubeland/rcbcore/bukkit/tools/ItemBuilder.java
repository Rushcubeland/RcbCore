...
public class ItemBuilder {
    ...
    public ItemBuilder removeFlags(){
        ItemMeta im = is.getItemMeta();
        assert im != null;
        im.addItemFlags(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_DESTROYS, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_UNBREAKABLE, ItemFlag.HIDE_POTION_EFFECTS, ItemFlag.HIDE_PLACED_ON);
        is.setItemMeta(im);
        return this;
    }
